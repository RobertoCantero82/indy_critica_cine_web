...
const FRASES = [
  ...
  "Cruzando desiertos y esquivando dardos venenosos para traerte la crítica...",
  ...
  "Sacudiéndome el polvo de tres tumbas egipcias de la barba mientras descargo los datos...",
  ...
  "Esperando a que termine de explotar el maíz en el microondas mientras se procesa la nota...",
